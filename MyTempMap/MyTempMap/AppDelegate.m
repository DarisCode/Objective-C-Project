...
//支援 IOS 2_0 到9_0, "Please use application:openURL:options:")
- (BOOL) application:(UIApplication *)application handleOpenURL:(NSURL *)url
{
    ...
    NSString *parameter = [path stringByReplacingOccurrencesOfString:@"hotMapWidgetApp://" withString:@""];
    
    NSLog(@"Receive Parameter: %@",parameter);
    
    
    
    // Try to notify Viewcontroller to jump to certain funtion
    
    //第一條路:沒有被啟動的時候被啟用
    self.jumpToFuncParameter = parameter;
